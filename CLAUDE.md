...
**This is NOT a monorepo.** The catalog data lives in [MyUSSDCodes-collection](https://github.com/albertolicea00/MyUSSDCodes-collection) and the iOS app in [MyUSSDCodes-ios](https://github.com/albertolicea00/MyUSSDCodes-ios) — separate repositories. Never add USSD code data here beyond the bundled seed asset.
