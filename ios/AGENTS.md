...
This is part of the My USSD Codes monorepo. The catalog source of truth is in
`../data/`; the Android app is in `../android/`. Keep app changes in this
directory and put catalog changes in `../data/` rather than modifying the
bundled seed resource.
